...
const ADMIN_LORA_TRAINING_PATH: &str = "/admin/training/jobs";
const ADMIN_SCHEMA_MANIFEST_PATH: &str = "/admin/schema/manifest";
const ADMIN_KV_PATH: &str = "/admin/kv";
const ADMIN_KV_CACHE_PATH: &str = "/admin/component-cache";
...
const ADMIN_MODEL_INIT_PATH: &str = "/admin/artifacts/init";
const ADMIN_MODEL_UPLOAD_PATH: &str = "/admin/artifacts/upload";
const ADMIN_MODEL_COMMIT_PATH: &str = "/admin/artifacts/commit";
