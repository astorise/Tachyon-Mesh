...
- [ ] Add the `/api/enroll` endpoint on standard nodes to accept inbound connections from pending nodes.
- [ ] Add the `/api/admin/approve-node` endpoint to accept the PIN from the UI, sign the certificate, and return it.
