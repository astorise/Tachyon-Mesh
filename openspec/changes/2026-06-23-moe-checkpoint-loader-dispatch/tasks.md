...
- [ ] **Task 2: Per-layer dense/MoE detection and mixed block loading**
...
- [ ] **Task 3: `ExpertPlacementPlan` from `hardware_strategy.expert_device_map`**
...
- [ ] **Task 4: `ExpertParallelLlama` model wrapper**
...
- [ ] **Task 5: Wire the load path in `candle_llm_runtime.rs`**
