...
pub(crate) const METERING_OUTBOX_RETRY_BATCH_LIMIT: usize = TELEMETRY_EXPORT_BATCH_SIZE;
#[cfg(not(test))]
...
#[cfg(not(test))]
pub(crate) const METERING_OUTBOX_RETRY_INTERVAL: Duration = Duration::from_secs(60);
#[cfg(test)]
pub(crate) const METERING_OUTBOX_RETRY_INTERVAL: Duration = Duration::from_millis(50);
