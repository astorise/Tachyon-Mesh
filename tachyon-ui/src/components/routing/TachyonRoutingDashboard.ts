  ...
  private render(): void {
    this.renderTemplate(`
      <section class="space-y-6 text-slate-300">
        <div data-stagger-panel class="flex items-center justify-between gap-4">
          <div>
        ...
        <form class="grid gap-6 lg:grid-cols-3">
          <div data-stagger-panel class="rounded-lg border border-slate-800 bg-slate-900 p-4">
          ...
          <div data-stagger-panel class="rounded-lg border border-slate-800 bg-slate-900 p-4 lg:col-span-2">
        ...
        <div id="feedback-zone" data-stagger-panel class="rounded-xl border border-slate-800 bg-slate-900 px-4 py-3 font-mono text-xs text-slate-400">Awaiting configuration.</div>
      </section>
    `);
  }
